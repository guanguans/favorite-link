...
- [MrPunyapal/laravel-client-validation: 一个强大的Laravel包，将服务器端验证规则带到使用Alpine.js的客户端。使用与Laravel后端相同的规则实时验证表单，包括对FormRequest类的支持以及复杂验证规则的AJAX回退。](https://github.com/MrPunyapal/laravel-client-validation) 
### December 29, 2025 
